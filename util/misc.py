...
def save_best_model(
    ...
    if is_best:
        filepath_best = output_dir / (f"{best_name}.pth.tar")
        shutil.copyfile(checkpoint_path, filepath_best)
        if update_overall_best and best_name != "best":
            shutil.copyfile(checkpoint_path, output_dir / "best.pth.tar")
...
def save_current_best_model(
    ...
    if is_best:
        ...
        shutil.copyfile(checkpoint_path, filepath_best)
        overall_best_path = output_dir / "best.pth.tar"
        shutil.copyfile(checkpoint_path, overall_best_path)
