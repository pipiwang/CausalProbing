...
def build_promis567_loader(args):
    train_transforms, val_transforms, test_transforms = get_transforms(args)
    train_set = Promis3HistSet(args, "spilt/promis567_hist/train.csv", 'train', train_transforms)
    val_set = Promis3HistSet(args, "spilt/promis567_hist/val.csv", 'val', val_transforms)
    test_set = Promis3HistSet(args, "spilt/promis567_hist/test.csv", 'test', test_transforms)
