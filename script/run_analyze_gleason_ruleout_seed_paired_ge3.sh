...
# Paired-seed analysis for Gleason Grade Group >= 3 vs Grade Group 1-2.
...
export BINARY_POSITIVE_MIN=3
export LABEL_DEFINITION=${LABEL_DEFINITION:-grade_group_ge_3}
